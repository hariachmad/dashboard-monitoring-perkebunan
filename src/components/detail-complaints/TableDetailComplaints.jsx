export const TableDetailComplaint = ({ props }) => {
  return (
    <>
      <div className=" w-full ">
        <div className="px-4 md:px-10 py-4 md:py-7">
          <div className="flex items-center justify-between">
            ...
            <div className="py-3 px-4 flex items-center text-sm font-medium leading-none text-gray-600 bg-gray-200 hover:bg-gray-300 cursor-pointer rounded mr-25">
              <p>Sort By:</p>
              <select
                aria-label="select"
        ...
        <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 max-w-[90%]">
                      ...
                      >
                        ...
                        <td className="pl-5">
                          <div className="py-3 px-3 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">
                            {new Date(row.complaintDate).toDateString()}
                          </div>
                        </td>
                        <td className="pl-4">
